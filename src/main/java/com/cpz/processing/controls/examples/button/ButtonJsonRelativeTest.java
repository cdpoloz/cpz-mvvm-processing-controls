 ...
 * @author CPZ
 */
public class ButtonJsonRelativeTest extends PApplet {
    private static final String BUTTON_CONFIG_PATH = "data" + File.separator + "config" + File.separator + "button-relative.json";
    ...
    public void setup() {
        ...
        button.setClickListener(() -> {
            System.out.println("You clicked the relative JSON button!");
            clickCount++;
        });
    ...
    public void draw() {
        background(28);
        button.draw();
        text(button.getCode() + " | Relative JSON click count = " + clickCount, 300, 200);
    }
