...
public final class DefaultTextFieldStyle implements TextFieldStyle {
   ...
   public DefaultTextFieldStyle(TextFieldStyleConfig config, TextFieldRenderer renderer) {
      if (config == null) {
         ...
         this.config = config;
         this.renderer = (TextFieldRenderer)(renderer == null ? new DefaultTextFieldRenderer() : renderer);
    ...
    */
   public void render(PApplet sketch, TextFieldViewState state, ThemeSnapshot snapshot) {
    ...
    */
   public TextFieldRenderStyle resolveRenderStyle(TextFieldViewState state, ThemeSnapshot snapshot) {
      ...
      return new TextFieldRenderStyle(color4, state.focused() ? this.blend(borderColor2, color6, 0.35F) : borderColor2, color5, state.focused() ? color6 : borderColor2, color7, color8, this.config.textSize, this.config.font);
   }
